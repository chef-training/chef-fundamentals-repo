...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "chef-user-starter"
  ...
  #   chef.chef_server_url = "https://uvo1sksghiuk1gyk2wk.vm.cld.sr/organizations/clownco"
  #   chef.validation_client_name = "clownco-validator"
  #   chef.validation_key_path = ".chef/clownco-validator.pem"
  # end
end
